...
preg_match("/\.(gif|bmp|png|jpg|jpeg|exe|zip|txt|mp3|mpg|wav|wma|doc|xls|ppt|html){1}$/i", $arquivo["name"], $ext);

// Renomear arquivo para evitar quebras
$file_nome = md5(uniqid(time())) . "." . $ext[1];

// upload e registro de pasta
$file_dir = "/home/mundosa/public_html/sites/up/arquivos/" . $file_nome;
